...
do
    ...
    local CATHUB = v4.CATHUB

    if type(CATHUB) ~= "table" then
        CATHUB = {
			slots = {}
		}
        v4.CATHUB = CATHUB
    ...
    if type(CATHUB.slots) ~= "table" then
        CATHUB.slots = {}
    end
    ...
    do
        ...
        for k, v in pairs(CATHUB.slots) do
    ...
    do
        ...
        do
            ...
            function v51()
                ...
                local v352 = CATHUB.slots[str]

                if type(v352) ~= "table" then
                    v352 = {}
                    CATHUB.slots[str] = v352
                end
            ...
            local function v78(p4)
                local logo = "rbxassetid://126031329785796"
                if p4 then
                    u76 = logo
                    return logo
                else
...
local v294 = v259("About", "CAT HUB for Steal an Egg")
...
if type(v324.UI) ~= "table" or not (function()
    local CATHUB = (getgenv and getgenv() or _G).CATHUB
    local v354 = type(CATHUB) == "table" and CATHUB.slots
...
(function()
    ...
    local u1195 = (function()
        ...
        local function v1811(p272)
            ...
            t184.text = v3018 == "" and "CAT HUB" or "CAT HUB · " .. v3018
            t183.footer = t184
    ...
    function v1243.KiraUnload()
        ...
        local CATHUB = v1243.CATHUB
        local v2673 = type(CATHUB) == "table" and (type(CATHUB.slots) == "table" and CATHUB.slots[str42])
    ...
    print("[UI] CAT HUB ready · RightShift toggles · Dark / Light in Settings")
