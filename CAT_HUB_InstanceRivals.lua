-- CAT HUB branding/library integration
local cathublib = loadstring(game:HttpGet("https://raw.githubusercontent.com/CatJackop/CATHUBGUI/refs/heads/main/CAT_HUB_GUI.luau"))()
local CATHUB_LOGO_ASSET = "rbxassetid://126031329785796"
local CATHUB_DISCORD = "https://discord.gg/yuaWVkXFQH"

local function CAT_HUB_Notify(text, duration)
    pcall(function()
        if cathublib and type(cathublib.Notify) == "function" then
            cathublib:Notify(text, duration or 4)
            return
        end
    end)
    pcall(function()
...
local Window = Library:CreateWindow({
    ...
    TabPadding = 6,
    MenuFadeTime = 0,
    RedRightText = ' Rivals | CAT HUB',
    Size = Vector2.new(700, 600),
})

-- CAT HUB movable logo / hide-show button
do
    local parent = (gethui and gethui()) or game:GetService('CoreGui')
    local gui = Instance.new('ScreenGui')
    gui.Name = 'CATHUB_Branding'
    gui.ResetOnSpawn = false
    gui.IgnoreGuiInset = true
    gui.ZIndexBehavior = Enum.ZIndexBehavior.Global
    gui.Parent = parent
...
CAT_HUB_Notify('CAT HUB loaded successfully!', 4)
CAT_HUB_Notify('Discord: ' .. CATHUB_DISCORD, 5)
...
-- CAT HUB Discord/branding tab
do
    local DiscordBox = Tabs.Discord:AddLeftGroupbox('CAT HUB')
    DiscordBox:AddLabel('CAT HUB')
    DiscordBox:AddLabel('Discord: ' .. CATHUB_DISCORD)
    DiscordBox:AddButton('Copy Discord Invite', function()
        pcall(function() setclipboard(CATHUB_DISCORD) end)
        CAT_HUB_Notify('CAT HUB Discord invite copied!', 4)
    end)
    DiscordBox:AddButton('CAT HUB Logo / Hide-Show', function()
        pcall(function() Window:Toggle() end)
    end)
end
