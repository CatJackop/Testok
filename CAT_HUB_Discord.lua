do
	...
	WindUI:Popup({
		Title = gradient("CAT HUB", Color3.fromHex("#eb1010"), Color3.fromHex("#1023eb")),
		Icon = "rbxassetid://126031329785796",
		Content = gradient("This script made by", Color3.fromHex("#10eb3c"), Color3.fromHex("#67c97a"))   .. gradient(" catjack.gg", Color3.fromHex("#001e80"), Color3.fromHex("#16f2d9")) ,
		Buttons = {
			{
	...
	local Window = WindUI:CreateWindow({
		Title = gradient("CAT HUB [SUMMER UPDATE]", Color3.fromHex("#001e80"), Color3.fromHex("#ffea00")),
		Icon = "rbxassetid://126031329785796",
		Author = gradient("catjack.gg", Color3.fromHex("#1bf2b2"), Color3.fromHex("#1bcbf2")),
		Folder = "CATHUB",
...
• Ctrl+M Toggle System
	...
	Tabs.SocialsTab:Paragraph({
		Title = "catjack.gg Made This Script",
		Desc = "Join my Discord server for updates, scripts, and announcements!\nDiscord: discord.gg/9gbcFasvzm",
		Image = "rbxassetid://126031329785796",
		ImageSize = 64
	});
	...
	Tabs.SocialsTab:Button({
		Title = "Copy Discord",
		Callback = function()
			if pcall(setclipboard, "https://discord.gg/9gbcFasvzm") then
				WindUI:Notify({
					Title = "Copied!",
					Content = "Discord invite copied! Join the server!",
					Icon = "check-circle",
					Duration = 3
				});
			end
	...
	Tabs.WindowTab:Button({
		...
		Callback = function()
			if fileNameInput ~= "" then
				makefolder("CATHUB");
				writefile("CATHUB/" .. fileNameInput .. ".json", HttpService:JSONEncode({
	...
	Tabs.WindowTab:Button({
		...
		Callback = function()
			if fileNameInput ~= "" and isfile("CATHUB/" .. fileNameInput .. ".json") then
				local data = HttpService:JSONDecode(readfile("CATHUB/" .. fileNameInput .. ".json"));
				if data.Theme then
	...
	print("CAT HUB Loaded - Press Ctrl+M to toggle script");
end